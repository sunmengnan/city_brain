...
class DeepCNN(object):
    ...
    def build_net(self, inputs):
        ...
        feature_maps = [32, 32, 64, 64, 128, 128, 256, 256, 512, 512, 512]
        """
...
if __name__ == '__main__':
    ...
    inputs = tf.placeholder(tf.float32, [1, 37, 315, 1], name="inputs")
    is_training = tf.placeholder(tf.bool, name="is_training")
    img_file = '/Users/cwq/data/test.jpg'

    net = DeepCNN(inputs, is_training)
